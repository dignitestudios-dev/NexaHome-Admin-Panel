...
const Donut = ({ value, color = "#065662", bgColor = "#EFEFEF" }: { value: number; color?: string; bgColor?: string }) => {
  const data = [{ value }]
...
<Card className="rounded-[40px] border-none shadow-sm h-[400px] flex flex-row overflow-hidden w-full bg-white">
  ...
  <CardContent className="flex-1 p-10 flex flex-col justify-between min-w-0">
