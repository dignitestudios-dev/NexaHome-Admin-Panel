...
const STATUS_OPTIONS: { label: string; value: SubscriptionStatusFilter }[] = [
  { label: "All", value: "all" },
...
type SubscriptionStatusFilterProps = {
  ...
  onApply: (status: SubscriptionStatusFilter) => void;
};
...
export function SubscriptionStatusFilter({
  ...
  const [selected, setSelected] = useState<SubscriptionStatusFilter>(value);
