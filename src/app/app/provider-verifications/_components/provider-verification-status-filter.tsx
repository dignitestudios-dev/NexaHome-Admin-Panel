...
const STATUS_OPTIONS: { label: string; value: ProviderVerificationStatus }[] = [
  { label: "All", value: "all" },
...
type ProviderVerificationStatusFilterProps = {
  ...
  onApply: (filters: { status: ProviderVerificationStatus }) => void;
};

export function ProviderVerificationStatusFilter({
  status = "all",
  onApply,
}: ProviderVerificationStatusFilterProps) {
  const [selectedStatus, setSelectedStatus] = useState<ProviderVerificationStatus>(status);
